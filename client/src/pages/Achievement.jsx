        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <img src="https://placehold.co/40x40/d1d5db/333333?text=Logo" alt="Logo" className="h-8 w-8 rounded-full" />
        ...
        <div className="bg-gradient-to-r from-indigo-300 to-orange-200 py-8 sm:py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center space-x-2 mb-2 sm:mb-4">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight">Achievements Wall</h1>
            </div>
            <p className="mt-2 text-md sm:text-lg text-gray-600 max-w-2xl mx-auto px-2">Celebrate your wins and <span className="font-semibold text-gray-800">Share</span> your hackathon victories, dojo belts, internships, and more.</p>
          </div>
